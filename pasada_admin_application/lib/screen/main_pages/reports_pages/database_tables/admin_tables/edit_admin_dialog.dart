...
class _EditAdminDialogState extends State<EditAdminDialog> {
  ...
  void initState() {
    ...
    _firstNameController.text =
        widget.adminData['first_name']?.toString() ?? '';
    _lastNameController.text = widget.adminData['last_name']?.toString() ?? '';
    _mobileNumberController.text =
        widget.adminData['admin_mobile_number']?.toString() ?? '';
    _usernameController.text =
        widget.adminData['admin_username']?.toString() ?? '';
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: <Widget>[
              ...
              _buildInfoRow(
                  'Admin ID:', widget.adminData['admin_id'].toString()),
              // Non-editable username field
              _buildInfoRow('Username:',
                  widget.adminData['admin_username']?.toString() ?? 'N/A'),
              SizedBox(height: 16),
